# 东北大学一网通办爬虫
![avatar image size](https://gss3.bdstatic.com/7Po3dSag_xI4khGkpoWK1HF6hhy/baike/c0%3Dbaike180%2C5%2C5%2C180%2C60/sign=21c72717ab773912d02b8d339970ed7d/8b13632762d0f703464bf4760afa513d2797c59b.jpg){:height="300px" width="300px"}
## 背景
...
* 支持各个课程对应的学分查询
* 如果可能，加入对数学机考预约系统的支持
* 由于目前教务处正进行数据迁移，在迁移成功后，将加入成绩、绩点查询，空教室查询（如果提供）
## 使用
...
***
## 注意事项
* 如果你想使用此爬虫来实现类似东大方圆、东大葫芦、weNeu这样的信息聚合平台，请尽量使用代理访问服务器，因为此在一网通办的每次登陆记录（含IP），都交无一遗漏地记录在用户登录日志中，用户读取这些日志便可得知登录IP，这对于服务器拥有者可能是危险的.即使日志是可删除的，但只能全部清空，我强烈不建议你每次登录成功都清除登录记录，这可能会给你的用户带来困扰.
